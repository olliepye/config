...
mkdir ~/.config/i3
wget https://github.com/olliepye/config/blob/master/i3config -P ~/.config/i3/
mv ~/.config/i3/i3config ~/.config/i3/config
mkdir ~/.config/i3status
wget https://github.com/olliepye/config/blob/master/i3status -P ~/.config/i3status/
mv ~/.config/i3status/i3status ~/.config/i3status/config

# enable transparent windows i3
sudo dnf install compton -y
mkdir ~/.config/compton
wget https://github.com/olliepye/config/blob/master/compton.conf -P ~/.config/compton/
...
mkdir ~/.vimrc
wget https://www.github.com/olliepye/config/blob/master/init.vim -P ~/.vimrc/
